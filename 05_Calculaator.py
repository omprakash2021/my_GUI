...
root = Tk()
root.title("Simple Calculator") #labeling this name to our calculator 

e = Entry(root,width=43,borderwidth=5)
e.grid(row=0,column=0,columnspan=3,padx=10,pady=10)
def button_click(number):
        # e.delete(0,END) #it will delete all data in Entry
        current=e.get()
        e.delete(0,END)
...
#creating button0
#lambda will take iput from buttons
